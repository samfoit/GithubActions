[![Run App Sam Foit](https://github.com/samfoit/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/samfoit/GithubActions/actions/workflows/run-app.yaml)
